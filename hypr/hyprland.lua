...
hl.on("hyprland.start", function()
	...
	hl.exec_cmd("awww img ~/dotfiles/themes/akira/wallpaper.png ")
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { "rgba(0d1e2cee)", "rgba(2a8defee)" }, angle = 45 },
			inactive_border = "rgba(11253dee)",
		},
...
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("hyprshot -m window --clipboard-only"))
hl.bind(mainMod .. " + SHIFT + Z", hl.dsp.exec_cmd("hyprshot -m region --clipboard-only"))
